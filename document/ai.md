...
+ 時代によって「AIとは」は変わっている
    ...
    失敗1(["無理ぽ＼(^o^)／<br>【AI冬の時代：1】"])
    失敗2(["無理ぽ＼(^o^)／<br>【AI冬の時代：2】"])
    途中(["やったか…！？( ﾟДﾟ)<br>発展途上"])

    AI1-->失敗1-->AI2-->失敗2-->AI3-->途中
    ```
...
+ mimicも、きっと仕組みはこう
    ...
    コンピュータ--"(4)出力"-->ユーザ
    ```
+ 当然、「誰からアップロードされたか」は区別できないし、する必要がない
    ```mermaid
    graph LR
    ユーザA((ユーザA))
    作品1["作品A<br>
...
## Midjourney事件
+ 2022年09月01日、GIAZINEが[画像生成AI「Midjourney」の描いた絵が美術品評会で1位を取ってしまい人間のアーティストが激怒](https://gigazine.net/news/20220901-midjourney-win-fine-arts-competition/)を公開
    > 2022年8月26日から開催されている第150回コロラド州品評会のデジタルアート部門において、ジェイソン・アレンという人物が提出した絵が1位を獲得しました。
    + 提出した絵の経緯について
        > Midjourneyで何百枚もの画像を生成して微調整を行い、最終的に残った3枚を選択して提出した
        
        > 他にアレン氏が行ったのは、Photoshopによる画像の微調整と、Gigapixel AIによる画像の拡大のみ
        + ラフスケッチを大量に作成して、その中から厳選して作品を作るのはどの作家も同じでは？
        + そして、厳選後の調整過程を人間が行っているなら、「デジタルアート部門」では他の作家と変わらないのでは？
        + 激怒したとされる[Genel Jumalonさん](https://twitter.com/GenelJumalon/media?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1564651635602853889%7Ctwgr%5Edf53f883a16793d7ee15a6fd36ada712d110177f%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fgigazine.net%2Fnews%2F20220901-midjourney-win-fine-arts-competition%2F)もデジタルアーティスト
            + Illustratorユーザが、Photoshopユーザに難癖をつけているようなもの
